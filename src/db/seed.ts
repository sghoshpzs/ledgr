...
export async function seedDemo() {
  ...
  const investments: Investment[] = [
    { name: 'Index fund SIP', type: 'MUTUAL_FUND', fundHouse: 'UTI Mutual Fund', debitBank: 'HDFC Bank', horizon: 'long', investedAmount: 300000, currentValue: 362000, startDate: mo(-30), monthlyContribution: 10000 },
    ...
    { name: 'NPS Tier I', type: 'NPS', horizon: 'long', investedAmount: 180000, currentValue: 214000, startDate: mo(-36), monthlyContribution: 5000, debitBank: 'HDFC Bank' },
    ...
    { name: 'RD – Post office', type: 'RD', horizon: 'short', investedAmount: 60000, currentValue: 62400, startDate: mo(-10), interestRate: 6.7, monthlyContribution: 6000, maturityDate: day(45), debitBank: 'State Bank of India' },
  ]
  const liabilities: Liability[] = [
    ...
    { name: 'Health insurance', type: 'HEALTH_INSURANCE', insurer: 'Star Health', debitBank: 'HDFC Bank', amount: 21500, frequency: 'yearly', nextDueDate: day(26) },
